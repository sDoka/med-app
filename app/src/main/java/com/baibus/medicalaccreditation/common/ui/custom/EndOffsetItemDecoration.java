...
public class EndOffsetItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public static EndOffsetItemDecoration newInstanceDimen(@DimenRes int id) {
        Resources resources = MedApplication.getInstance().getResources();
        int startOffsetPx = resources.getDimensionPixelOffset(id);
        return new EndOffsetItemDecoration(startOffsetPx);
    }
    /**
    ...
    public static EndOffsetItemDecoration newInstanceDrawable(@DrawableRes int id) {
        Drawable drawable = ContextCompat.getDrawable(MedApplication.getInstance(), id);
        return new EndOffsetItemDecoration(drawable);
    }
