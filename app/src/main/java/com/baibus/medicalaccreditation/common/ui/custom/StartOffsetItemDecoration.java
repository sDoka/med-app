...
public class StartOffsetItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public static StartOffsetItemDecoration newInstanceDimen(@DimenRes int id) {
        Resources resources = MedApplication.getInstance().getResources();
        int startOffsetPx = resources.getDimensionPixelOffset(id);
        return new StartOffsetItemDecoration(startOffsetPx);
    }
    /**
    ...
    public static StartOffsetItemDecoration newInstanceDrawable(@DrawableRes int id) {
        Drawable drawable = ContextCompat.getDrawable(MedApplication.getInstance(), id);
        return new StartOffsetItemDecoration(drawable);
    }
