...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public static DividerItemDecoration newInstance(@DrawableRes int id) {
        Drawable dividerDrawable = ContextCompat.getDrawable(MedApplication.getInstance(), id);
        return new DividerItemDecoration(dividerDrawable);
    }
