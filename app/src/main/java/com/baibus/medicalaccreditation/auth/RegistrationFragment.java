...
import com.baibus.medicalaccreditation.databinding.FragmentRegistrationBinding;

public class RegistrationFragment extends Fragment<RegistrationFragment, FragmentRegistrationBinding, RegistrationVM, RegistrationVM.FactoryVM> {
    final static String TAG = RegistrationFragment.class.getName();
    ...
    @NonNull
    @Override
    protected RegistrationVM.FactoryVM getFactory() {
        return new RegistrationVM.FactoryVM();
    }

    @NonNull
    @Override
    protected RegistrationFragment getThis() {
        return this;
    }
